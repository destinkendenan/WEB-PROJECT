...
{{-- <x-app-layout>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            <!-- Header Section -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-800 mb-2">Employer Profile</h1>
                <p class="text-gray-600">Manage your company profile and information</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="border-b pb-3">
                                <p class="text-sm text-gray-500 mb-1">Phone</p>
                                <p class="text-gray-800 font-medium">{{ $employerProfile->phone ?? '-' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="border-b pb-3">
                                <p class="text-sm text-gray-500 mb-1">Company Name</p>
                                <p class="text-gray-800 font-medium">{{ $employerProfile->company_name ?? '-' }}</p>
                            </div>

                            <div class="border-b pb-3">
                                <p class="text-sm text-gray-500 mb-1">Industry</p>
                                <p class="text-gray-800 font-medium">{{ $employerProfile->industry ?? '-' }}</p>
                            </div>

                            <div class="border-b pb-3">
                                <p class="text-sm text-gray-500 mb-1">Website</p>
                                @if(!empty($employerProfile->website))
                                    <a href="{{ $employerProfile->website }}" 
                                       class="text-blue-600 hover:text-blue-800 font-medium">
                    ...
                    <div class="mt-8">
                        <p class="text-sm text-gray-500 mb-2">Company Description</p>
                        <div class="bg-gray-50 rounded-lg p-4">
                            <p class="text-gray-700">{{ $employerProfile->company_description ?? '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        <p class="text-sm text-gray-500 mb-2">Address</p>
                        <div class="bg-gray-50 rounded-lg p-4">
                            <p class="text-gray-700">{{ $employerProfile->address ?? '-' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Footer Actions -->
                <div class="bg-gray-50 px-6 py-4 flex justify-end">
                    <a href="{{ route('employers.edit', $employerProfile->user_id ?? Auth::id()) }}" 
                       class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition ease-in-out duration-150">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                        </svg>
